...
create rel table hasMember (FROM Forum TO Person, joinDate STRING);
...
create rel table knows (FROM Person TO Person, creationDate STRING);
create rel table likes_Comment (FROM Person TO Comment, creationDate STRING);
create rel table likes_Post (FROM Person TO Post, creationDate STRING);
create rel table studyAt (FROM Person TO Organisation, classYear STRING, MANY_ONE);
create rel table workAt (FROM Person TO Organisation, workFrom STRING);
